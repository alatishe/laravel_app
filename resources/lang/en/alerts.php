...
return [
    ...
    */
    ...
    'backend' => [
        ...
        'carriers' => [
            'created' => 'The carrier was successfully created.',
            'updated' => 'The carrier was successfully updated.',
            'deleted' => 'The carrier was successfully deleted.',
        ],

        'rates' => [
            'created' => 'The rate was successfully uploaded using the CSV file uploaded.',
            'updated' => 'The rate was successfully updated.',
            'deleted' => 'The rate was successfully deleted.',
            'error' => 'Please upload the correct content using the sample CSV file.',
            'blank' => 'Please upload a CSV file.',
        ],
