    ...
    <div class="row">
        <div class="col-sm-5">
            <h4 class="card-title mb-0">
                Custom carriers
                <small class="text-muted">{{ (isset($blog)) ? 'Carrier Edit' : 'Carrier Create'}} </small>
            </h4>
        </div>
        <!--col-->
    </div>
    ...
    <div class="row mt-4 mb-4">
        <div class="col">
            <div class="form-group row">
                {{ Form::label('name', 'Carrier Title', ['class' => 'col-md-2 from-control-label required']) }}
            ...
            <div class="form-group row">
                {{ Form::label('status', 'Carrier Status', ['class' => 'col-md-2 from-control-label required']) }}
